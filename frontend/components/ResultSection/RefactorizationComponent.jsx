...
const RefactorizationComponent = ({ code }) => {
  ...
  const RefactorButton = () => {
    return (
      <>
        <h1 className="py-2 my-auto text-center">Updated Code</h1>
        <div className="h-full w-full flex-center flex-col bg-[#1e1e1e]">
          <button
  ...
  const render = [
    <RefactorButton key="refactorButton" />,
    <LoadingState key="loadingState" />,
    <RefactoredOutput key="refactoredOutput" />,
  ];

  return (
    <div>
      <h1 className="mb-5 text-3xl">Code Refactorization</h1>
      <p>
      ...
      <div className="flex flex-row h-64 mt-10 border-t-2 border-x-2">
        <div className="w-1/2">
          <h1 className="py-2 my-auto text-center">Original Code</h1>
          <Editor
            height="100%"
            width="100%"
            theme="vs-dark"
